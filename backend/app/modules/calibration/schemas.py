...
class ZoneOptionResponse(CalibrationPublicModel):
    ...
    activation_behavior: Literal["calculated_result_stays_pending"]
...
class CalibrationProtocolResponse(CalibrationPublicModel):
    ...
    calculated_result: Literal["threshold_and_zone_profiles",]
    pending_zone_lifecycle: Literal["confirmation_creates_pending_proposal",]
